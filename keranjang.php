...
<body>
				...
				<div class="col-12 col-md-10 d-none d-xl-block">
					<nav class="site-navigation position-relative text-right" role="navigation">
						...
						<ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
							...
							<li><a href="keranjang.php" class="nav-link active" style="color: #e1e1e1;"><i class="icon-shopping-cart"></i></a></li>
	...
	<!-- Footer -->
	<footer class="page-footer bg-dark font-small stylish-color-dark pt-4" style="color: white; margin-top: 450px;">
